...
function appSettingsToYAML(appSettings, withComments, extra) {
    ...
    if (extra.header && extra.version) {
        lines.push("# generated by Turnilo version " + extra.version, "# for a more detailed walk-through go to: https://github.com/yahoo/swiv/blob/v" + extra.version + "/docs/configuration.md", "");
    }
    if (extra.verbose) {
        if (withComments) {
