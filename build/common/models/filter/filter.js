...
var Filter = (function () {
    ...
    Filter.fromJS = function (parameters) {
        ...
        else if (expression instanceof plywood_1.AndExpression) {
            clauses = expression.getExpressionList().map(function (c) { return filter_clause_1.FilterClause.fromExpression(c); });
        }
        else {
            clauses = [filter_clause_1.FilterClause.fromExpression(expression)];
        }
        return new Filter(immutable_1.List(clauses));
    };
