...
var external_system_1 = require("../external-system/external-system");
...
var Customization = (function () {
    function Customization(parameters) {
        ...
        if (parameters.externalSystem)
            this.externalSystem = parameters.externalSystem;
    ...
    Customization.fromJS = function (parameters) {
        ...
        if (parameters.externalSystem) {
            value.externalSystem = external_system_1.ExternalSystem.fromJS(parameters.externalSystem);
        }
    ...
    Customization.prototype.toJS = function () {
        ...
        if (this.externalSystem)
            js.externalSystem = this.externalSystem;
        if (this.timezones) {
