...
var Splits = (function () {
    ...
    Splits.prototype.changeSortExpression = function (sort) {
        return new Splits(this.splitCombines.map(function (s) { return s.changeSortExpression(sort); }));
    };
    Splits.prototype.changeSortExpressionFromNormalized = function (sort, dimensions) {
        return new Splits(this.splitCombines.map(function (s) { return s.changeSortExpressionFromNormalized(sort, dimensions); }));
    };
    ...
    Splits.prototype.updateWithFilter = function (filter, dimensions) {
        ...
        var newSplitCombines = this.splitCombines.map(function (splitCombine) {
            ...
            if (splitKind === "time") {
                return splitCombine.changeBucketAction(new plywood_1.TimeBucketExpression({
                ...
                return splitCombine.changeBucketAction(new plywood_1.NumberBucketExpression({
    ...
    Splits.prototype.changeSortIfOnMeasure = function (fromMeasure, toMeasure) {
        ...
        var newSplitCombines = this.splitCombines.map(function (splitCombine) {
            ...
            if (!sortAction || sortAction.refName() !== fromMeasure)
                return splitCombine;
            changed = true;
            return splitCombine.changeSortExpression(new plywood_1.SortExpression({
