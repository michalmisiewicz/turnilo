...
var DataCube = (function () {
    ...
    DataCube.prototype.updatedText = function (timekeeper, timezone) {
        ...
        if (refreshRule.isRealtime()) {
            ...
            return "Fixed to " + time_1.getWallTimeString(refreshRule.time, timezone);
        }
        else {
    ...
    DataCube.prototype.deduceAttributes = function () {
        ...
        measures.forEachMeasure(function (measure) {
            ...
            var countDistinctReferences = measure_1.Measure.getCountDistinctReferences(measure.expression);
            for (var _i = 0, references_2 = references; _i < references_2.length; _i++) {
                ...
                if (countDistinctReferences.indexOf(reference) !== -1) {
                    attributes.push(plywood_1.AttributeInfo.fromJS({ name: reference, type: "STRING", nativeType: "hyperUnique" }));
                }
                else {
    ...
    DataCube.prototype.addAttributes = function (newAttributes) {
        ...
        for (var _i = 0, newAttributes_1 = newAttributes; _i < newAttributes_1.length; _i++) {
            ...
            var name = newAttribute.name, type = newAttribute.type, nativeType = newAttribute.nativeType;
    ...
    DataCube.prototype.getDefaultSortExpression = function () {
