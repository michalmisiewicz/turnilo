...
var SettingsManager = (function () {
    ...
    SettingsManager.prototype.getClusterManagerFor = function (clusterName) {
        return immutable_class_1.SimpleArray.find(this.clusterManagers, function (clusterManager) { return clusterManager.cluster.name === clusterName; });
    };
    ...
    SettingsManager.prototype.getFileManagerFor = function (uri) {
        return immutable_class_1.SimpleArray.find(this.fileManagers, function (fileManager) { return fileManager.uri === uri; });
    };
